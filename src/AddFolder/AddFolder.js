...
export default class AddFolder extends Component {
  ...
  formValid() {
    ...
    console.log(this.state.folderNameValid)
  }
      ...
      <section className='AddFolder'>
        ...
        <NotefulForm onSubmit={this.handleSubmit}>
          <div className='field'>
            ...
            <input type='text' id='folder-name-input' name='folder-name' onChange={e => this.updateFolder} />
            
            <ValidationError hasError={!this.folderNameValid} message={this.state.validationMessages.folderName}/>
            {console.log(!this.folderNameValid)}
          </div>
          <div className='buttons' >
            <button type='submit' >
              Add folder
